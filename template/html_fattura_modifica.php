...
class Html_fattura_modifica {

    public function Form_fattura_modifica($fattura, $progetti, $formLink, $annullaLink, $csrf, $csrfname) {

        $datafattura = $fattura->getDataStr();
        // HTML
        $html = "
        ...
        <div class='col-md-6'>    
            <div class='form-group'>
                ...
                <input type='text' class='form-control' name='data' id='data' placeholder='Data fattura' value='$datafattura' required>
            </div>
        </div>
        ...
        <div class='col-md-6'>    
            <div class='form-group'>
                ...
                <input type='number' class='form-control' required name='numero' min='1' max='999' value='$fattura->numero' step='1'>
            </div>
        </div>
        ...
        foreach ($progetti as $opz) {
            if($opz->progettoid == $fattura->progettofk) {
                $selected = "selected";
            } else {
                $selected = "";
            }
            ...
            echo "<option value='$opz->progettoid' ".$selected.">$opz->descrizione - $cliente ($tipologia)</option>";
        }
        ...
        <div class='col-md-12'>    
            <div class='form-group'>
                ...
                <input type='text' class='form-control' id='oggetto' placeholder='Oggetto' name='oggetto' value='$fattura->oggetto' required>
            </div>
        </div>
        ...
        <div class='col-md-6'>    
            <div class='form-group'>
                ...
                <input type='number' class='form-control' id='importo' required name='importo' min='0' max='999999' value='$fattura->importo' step='0.01'>
            </div>
        </div>
        ...
        <div class='col-md-4'>    
            <div class='form-group'>
                ...
                <input type='number' class='form-control' id='totale' required name='totale' min='0' max='999999' value='$fattura->totale' step='0.01' readonly>
            </div>
        </div>
        ...
        <div class='form-group'>
            ...
            <div class='form-check'>
                <label class='form-check-label'><input type='checkbox' name='pagato' class='form-check-input' ".($fattura->pagato?'checked':'').">Pagato</label>
            </div>
        </div>
        </div>
        ...
        <div class='row'>
            ...
            <div class='col-md-6 paddingBottom20'>
                <input type='hidden' name='id' value='$fattura->fatturaid'>
